//
//  CAPresentationsViewController.swift
//  CoreApplication
//
...
class CAPresentationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, FilterProtocol {
    ...
    func initialSetup() {
        ...
        //Add Observer
        NotificationCenter.default.addObserver(self, selector: #selector(searchApi(notification:)), name: NSNotification.Name("presentationsNotification"), object: nil)
...
//        NotificationCenter.default.addObserver(self, selector: #selector(callPresentationApi(notification:)), name: NSNotification.Name("presentationApiCall"), object: nil)


        callApiForPresentationsData(searchText: "", noFilter: false)
    }
...
//    @objc func callPresentationApi(notification: NSNotification) {
//        let dict = notification.object as! NSDictionary
//        let str = "\(dict["searchValue"] as! String)".trimmingCharacters(in: .whitespaces).lowercased()
//        callApiForPresentationsData(searchText: str, noFilter: false)
//    }
    ...
    @objc func searchApi(notification: NSNotification) {
        ...
        callApiForPresentationsData(searchText: str, noFilter: true)
...
//                }
    ...
    @IBAction func filterButtonAction(_ sender: Any) {
        ...
        filterVC.fromWhere = "presentation"
    ...
    func filterList(strValue: String) {
        callApiForPresentationsData(searchText: strValue, noFilter: false)
    }

    
    //MARK: Call API
    func callApiForPresentationsData(searchText: String, noFilter: Bool)
    {
        var dict = Dictionary<String, AnyObject>()
        var val = Int()
        val = NSUSERDEFAULT.integer(forKey: "presentationFilter")
        ...
        CAServiceHelper.request(dict, method: .get, apiName: pPresentation, hudType: .simple) { (result, error, status) in
